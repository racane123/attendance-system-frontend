...
const ReliableQRScanner = ({ onScan, onError, isActive = false }) => {
  ...
  }, [scanner, selectedDevice, getAvailableCameras, handleScanSuccess, handleScanFailure, onError]);
    ...
    <div className="space-y-4">
      ...
      <div className="bg-blue-50 p-3 rounded-lg border border-blue-200">
        ...
        <ul className="text-xs text-blue-700 space-y-1">
          ...
          {availableDevices.length > 1 && (
            <li>• Select the appropriate camera if multiple are available</li>
          )}
        </ul>
      </div>
    </div>
...
export default ReliableQRScanner; 